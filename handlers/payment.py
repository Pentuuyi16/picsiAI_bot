...
async def back_to_photo_animation_handler(callback: CallbackQuery):
    """Обработчик кнопки 'Назад' - возврат к разделу 'Оживление фото'"""
...
async def back_to_video_generation_handler(callback: CallbackQuery):
    """Обработчик кнопки 'Назад' - возврат к разделу 'Создание видео'"""
    from database.database import Database
    ...
    text = (
        ...
        "1️⃣ <b><i>Выберите</i></b>, как хотите работать — отправить текст с идеей или загрузить фото.\n"
        "2️⃣ <b><i>Опишите настроение или сюжет</i></b>: атмосферу, действие, эмоцию или просто ключевые слова.\n"
        "3️⃣ <b><i>Подождите несколько минут</i></b> — бот соберёт для вас стильный и выразительный видеоролик.\n\n"
        "🔥 <b>Доступны два способа создания видео:</b>\n\n"
        "• <b><i>По промпту</i></b> — напишите свою задумку, и бот соберёт по ней уникальный видеосюжет.\n"
        "• <b><i>По фото</i></b> — загрузите изображение, и бот создаст видео, вдохновлённое вашим кадром.\n\n"
        "Каждую вашу <b><i>мысль</i></b> можно превратить в историю — дайте ей зажить в видео 💫\n\n"
        f"<blockquote>💰 Ваш баланс: {balance:.2f} ₽\n"
...
async def back_to_image_editing_handler(callback: CallbackQuery):
    """Обработчик кнопки 'Назад' - возврат к разделу 'Редактирование изображений'"""
    from database.database import Database
